(function(window){
    ...
    Heart = function() {
        ...
        for (var i = 10; i < 30; i += 0.2) {
            ...
            y = 19 * Math.cos(t) - 5 * Math.cos(2 * t) + Math.cos(3 * t) + Math.cos(4 * t);
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || 'rgb(20,' + random(0, 255) + ',' + random(0, 255) + ')';
